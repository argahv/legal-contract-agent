...
/* Neumorphic card: same clay surface as page; depth from dual shadows. */
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[32px] bg-card text-card-foreground shadow-extruded transition-all duration-300 ease-out",
      className,
    )}
    {...props}
  />
